"""
Django settings for fryer_38518 project.
...
WSGI_APPLICATION = 'fryer_38518.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fryer_38518 API",
    "DESCRIPTION": "API documentation for fryer_38518 App",
    "VERSION": "v1",
}
